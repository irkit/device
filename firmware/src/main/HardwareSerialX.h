/*
  HardwareSerialX.h - Hardware serial library for Wiring, with XON/XOFF software flow control
...
#ifndef HardwareSerialX_h
#define HardwareSerialX_h
...
extern HardwareSerialX Serial1X;
