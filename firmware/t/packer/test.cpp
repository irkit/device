...
int main() {
...

    {
        ...
        setBuffer16( input, 73,
                     0x440d, 0x2233,
                     0x047e, 0x047e, 0x047e, 0x0d0d, 0x047e, 0x0d0d,
        ...
        setBuffer8( expected, 21,
                    0x9f, 0x8b,
                    0x01, 0x50, 0x6f, 0x41,
                    0x15, 0x15, 0x54, 0x01, 0x51, 0x00, 0x14, 0x44, 0x00,
                    0xff, 0x00, 0x8b, 0x9f, 0x77, 0x50
                    );
...

    {
        ...
        setBuffer8( expected, 21,
                    0x82, 0x6e,
                    0x01, 0x46, 0x66, 0x71,
                    0x04, 0x40, 0x50, 0x14, 0x00, 0x00, 0x00, 0x40, 0x00, 0x40, 0x10, 0x00, 0x45, 0x55, 0x00
                    );
...

    {
        ...
        setBuffer8( expected, 40,
                    0x82, 0x6e,
                    0x01, 0x46, 0x66, 0xff,
                    0x04, 0x40, 0x50, 0x14, 0x00, 0x00, 0x00, 0x40, 0x00, 0x40, 0x15, 0x55, 0x41, 0x00, 0x00, 0x50,
                    0x40, 0x11, 0x40, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x10, 0x14, 0x04,
                    0x66, 0x46
                    );
...

    {
        ...
        setBuffer8( expected, 363,
                    
                    );
